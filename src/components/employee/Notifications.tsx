  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      title: 'New Work Ticket Assigned',
      message: 'You have been assigned a new work ticket: "Implement user authentication module"',
    ...
    },
    {
      ...
      message: 'Your work ticket "Database optimization" has been approved by the manager.',
    ...
    },
    {
      ...
      message: 'Your task "API documentation" is due tomorrow. Please ensure completion.',
    ...
    },
    {
      ...
      message: 'Congratulations! You have completed your monthly hours target of 160 hours.',
    ...
    },
    {
      ...
      title: 'Work Ticket Needs Revision',
      message: 'Your work ticket "Frontend improvements" requires revision. Please check the feedback.',
